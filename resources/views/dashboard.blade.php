    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6" style="width: 100%">
                <h2 class="text-lg font-semibold text-gray-700 mb-4 text-center">Kesesuaian & Lingkup Profesi Lulusan
                </h2>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-600">
                        ...
                        <tbody class="text-center">
                            @foreach ($dataKesesuaian as $row)
                                <tr class="border-b border-gray-100">
                                    <td class="px-4 py-4">{{ $row['tahun'] }}</td>
                                    <td class="px-4 py-4">{{ $row['jumlah_lulusan'] }}</td>
                                    <td class="px-4 py-4">{{ $row['terlacak'] }}</td>
                                    <td class="px-4 py-4">{{ $row['infokom'] }}</td>
                                    <td class="px-4 py-4">{{ $row['non_infokom'] }}</td>
                                    <td class="px-4 py-4">{{ $row['internasional'] }}</td>
                                    <td class="px-4 py-4">{{ $row['nasional'] }}</td>
                                    <td class="px-4 py-4">{{ $row['wirausaha'] }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6" style="width: 100%">
                <h3 class="text-lg font-semibold text-gray-700 mb-4 text-center">Sebaran Profesi Alumni</h3>
            ...
            <div class="flex gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6" style="width: 50%">
                    <h2 class="text-lg font-semibold text-gray-700 mb-4 text-center">Masa Tunggu Lulusan</h2>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-600">
                            ...
                            <tbody class="text-center">
                                @foreach ($rataRataMasaTunggu as $data)
                                    <tr class="border-b border-gray-100">
                                        <td class="px-4 py-4">{{ $data['tahun'] }}</td>
                                        <td class="px-4 py-4">{{ $data['jumlah_lulusan'] }}</td>
                                        <td class="px-4 py-4">{{ $data['terlacak'] }}</td>
                                        <td class="px-4 py-4">{{ $data['rata_rata_bulan'] }} bulan</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
