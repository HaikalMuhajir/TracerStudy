...
class AlumniImport implements ToCollection, WithHeadingRow
{
    ...
    private function transformDate($excelDate)
    {
        ...
        try {
            // Jika isinya angka (serial Excel), konversi pakai PhpSpreadsheet
            ...
            // Jika sudah dalam format tanggal string, langsung parse dengan Carbon
            return Carbon::parse($excelDate)->format('Y-m-d');
        } catch (\Exception $e) {
            return null; // fallback kalau format invalid
        }
    }
